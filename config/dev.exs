...
config :cms, CmsWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "9zxw8sCSaULS34y1onOdrLZlw62hBmxGs58xI6Jl8NEp8h9PpzfJGnKJ76S62gkG",
  watchers: [
...
config :cms, CmsWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/cms_web/router\.ex$"E,
      ~r"lib/cms_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
